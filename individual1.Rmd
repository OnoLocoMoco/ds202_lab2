...
I think the percentage of cacao only seems to affect the ratings at particularly high concentrations. Most of the mean ratings and the ranges for the scores are quite similar from the mid 50s up to the low 80s. As the percentage of cacao increases from there, there is greater variability in the both the rating means and IQR. 

<hr>
<h5>collaboration</h5>
<hr>
I am interested in how the combination of ingredients relates to the overall rating score. Because the ingredients is a categorical variable consisting of ingredient combination, we can make a factor of that data column and extract the levels from that list of factors. I will use that in my boxplot to show the relationship between the the rating and the ingredient combinations. 
...
boxplot(choco$Rating ~ choco_type2, las=2)
